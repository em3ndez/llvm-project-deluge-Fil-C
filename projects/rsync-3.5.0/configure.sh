...
# Generated by GNU Autoconf 2.72 for rsync.
#
...
Optional Features:
  ...
  --enable-coverage       build with gcov instrumentation for `make coverage`
  --disable-openat2       do not use Linux openat2(RESOLVE_BENEATH); force the
                          portable resolver (for exercising the fallback tier)
...
then :
  ...
  e) ac_cv_header_sys_types_h_makedev=no ;;
esac
fi
rm -f core conftest.err conftest.$ac_objext conftest.beam \
    conftest$ac_exeext conftest.$ac_ext
...
printf "%s\n" "#define GCOV_COVERAGE 1" >>confdefs.h

fi

# Check whether --enable-openat2 was given.
if test ${enable_openat2+y}
then :
  enableval=$enable_openat2;
fi
...
then :
  ...
  e)  RSYNCD_SYSCONF="/etc/rsyncd.conf"  ;;
esac
fi
...
then :
  ...
  e) rsync_cv_HAVE_BROKEN_LARGEFILE=no ;;
esac
fi
rm -f core *.core core.conftest.* gmon.out bb.out conftest$ac_exeext \
  conftest.$ac_objext conftest.beam conftest.$ac_ext ;;
...
then :
  ...
  e) ac_cv_lib_z_deflateParams=no ;;
esac
fi
rm -f core conftest.err conftest.$ac_objext conftest.beam \
    conftest$ac_exeext conftest.$ac_ext
...
then :
  ...
  e) ac_cv_search_EVP_MD_CTX_copy=no ;;
esac
fi
rm conftest.$ac_ext
LIBS=$ac_func_search_save_LIBS ;;
...
then :
  ...
  e) err_msg="$err_msg$nl- Failed to find EVP_MD_CTX_copy function in openssl crypto lib.";
...
then :
  ...
  e) ac_cv_search_XXH64_createState=no ;;
esac
fi
rm conftest.$ac_ext
LIBS=$ac_func_search_save_LIBS ;;
...
then :
  ...
  e) err_msg="$err_msg$nl- Failed to find XXH64_createState function in xxhash lib.";
...
then :
  ...
  e) ac_cv_search_ZSTD_minCLevel=no ;;
esac
fi
rm conftest.$ac_ext
LIBS=$ac_func_search_save_LIBS ;;
...
then :
  ...
  e) err_msg="$err_msg$nl- Failed to find ZSTD_minCLevel function in zstd lib.";
	     no_lib="$no_lib zstd" ;;
esac
fi
...
extern "C"
#endif
char LZ4_compress_default (void);
int
main (void)
{
...
then :
  ...
  e) ac_cv_search_LZ4_compress_default=no ;;
esac
fi
rm conftest.$ac_ext
LIBS=$ac_func_search_save_LIBS ;;
...
then :
  ...
  e) err_msg="$err_msg$nl- Failed to find LZ4_compress_default function in lz4 lib.";
	     no_lib="$no_lib lz4" ;;
esac
fi
...
then :
  ...
  e) rsync_cv_MAKEDEV_TAKES_3_ARGS=no ;;
esac
fi
rm -f core *.core core.conftest.* gmon.out bb.out conftest$ac_exeext \
  conftest.$ac_objext conftest.beam conftest.$ac_ext ;;
...
then :
  ...
  e) if ac_fn_c_compute_int "$LINENO" "(long int) (sizeof (int16_t))" "ac_cv_sizeof_int16_t"        "$ac_includes_default"
then :

else case e in #(
  e) if test "$ac_cv_type_int16_t" = yes; then
     { { printf "%s\n" "$as_me:${as_lineno-$LINENO}: error: in '$ac_pwd':" >&5
printf "%s\n" "$as_me: error: in '$ac_pwd':" >&2;}
...
then :
  ...
  e) if ac_fn_c_compute_int "$LINENO" "(long int) (sizeof (uint16_t))" "ac_cv_sizeof_uint16_t"        "$ac_includes_default"
then :

else case e in #(
  e) if test "$ac_cv_type_uint16_t" = yes; then
     { { printf "%s\n" "$as_me:${as_lineno-$LINENO}: error: in '$ac_pwd':" >&5
printf "%s\n" "$as_me: error: in '$ac_pwd':" >&2;}
...
then :
  ...
  e) if ac_fn_c_compute_int "$LINENO" "(long int) (sizeof (int32_t))" "ac_cv_sizeof_int32_t"        "$ac_includes_default"
then :
...
then :
  ...
  e) if ac_fn_c_compute_int "$LINENO" "(long int) (sizeof (uint32_t))" "ac_cv_sizeof_uint32_t"        "$ac_includes_default"
then :

else case e in #(
  e) if test "$ac_cv_type_uint32_t" = yes; then
     { { printf "%s\n" "$as_me:${as_lineno-$LINENO}: error: in '$ac_pwd':" >&5
printf "%s\n" "$as_me: error: in '$ac_pwd':" >&2;}
...
then :
  ...
  e) if ac_fn_c_compute_int "$LINENO" "(long int) (sizeof (char*))" "ac_cv_sizeof_charp"        "$ac_includes_default"
then :

else case e in #(
  e) if test "$ac_cv_type_charp" = yes; then
     { { printf "%s\n" "$as_me:${as_lineno-$LINENO}: error: in '$ac_pwd':" >&5
printf "%s\n" "$as_me: error: in '$ac_pwd':" >&2;}
...
then :
  ...
  e) rsync_cv_HAVE_GETADDR_DEFINES=no ;;
esac
fi
rm -rf conftest*
 ;;
...
then :
  ...
  e) as_fn_error $? "rsync requires poll(); please report the platform to the rsync developers" "$LINENO" 5 ;;
esac
fi

done
if test x"$ac_cv_header_poll_h" != x"yes"; then
    as_fn_error $? "rsync requires <poll.h>; please report the platform to the rsync developers" "$LINENO" 5
fi
...
then :
  ...
  e) ac_cv_lib_resolv_strcasecmp=no ;;
esac
fi
rm -f core conftest.err conftest.$ac_objext conftest.beam \
    conftest$ac_exeext conftest.$ac_ext
...
if ac_fn_c_try_link "$LINENO"
then :
  rsync_cv_HAVE_DIRFD=yes
else case e in #(
  e) rsync_cv_HAVE_DIRFD=no ;;
esac
fi
rm -f core conftest.err conftest.$ac_objext conftest.beam \
    conftest$ac_exeext conftest.$ac_ext ;;
...
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: result: $rsync_cv_HAVE_DIRFD" >&5
printf "%s\n" "$rsync_cv_HAVE_DIRFD" >&6; }
...
then :
  ...
  e) rsync_cv_have_sys_fallocate=no ;;
esac
fi
rm -f core conftest.err conftest.$ac_objext conftest.beam conftest.$ac_ext ;;
esac
...
then :
  ...
  e) enable_iconv_open=$ac_cv_func_iconv_open ;;
esac
fi
...
then :
  ...
  e) enable_iconv=$enable_iconv_open ;;
esac
fi
...
then :
  ...
  e) rsync_cv_chown_modifies_symlink=no ;;
esac
fi
rm -f core *.core core.conftest.* gmon.out bb.out conftest$ac_exeext \
  conftest.$ac_objext conftest.beam conftest.$ac_ext ;;
...
then :
  ...
  e) rsync_cv_can_hardlink_symlink=no ;;
esac
fi
rm -f core *.core core.conftest.* gmon.out bb.out conftest$ac_exeext \
  conftest.$ac_objext conftest.beam conftest.$ac_ext ;;
...
then :
  ...
  e) rsync_cv_can_hardlink_special=no ;;
esac
fi
rm -f core *.core core.conftest.* gmon.out bb.out conftest$ac_exeext \
  conftest.$ac_objext conftest.beam conftest.$ac_ext ;;
...
then :
  ...
  e) rsync_cv_HAVE_BROKEN_READDIR=no ;;
esac
fi
rm -f core *.core core.conftest.* gmon.out bb.out conftest$ac_exeext \
  conftest.$ac_objext conftest.beam conftest.$ac_ext ;;
...
then :
  ...
  e) rsync_cv_HAVE_STRUCT_UTIMBUF=no ;;
esac
fi
rm -f core conftest.err conftest.$ac_objext conftest.beam conftest.$ac_ext ;;
esac
...
then :
  ...
  e) rsync_cv_HAVE_GETTIMEOFDAY_TZ=no ;;
esac
fi
rm -f core conftest.err conftest.$ac_objext conftest.beam conftest.$ac_ext ;;
esac
...
then :
  ...
  e) rsync_cv_HAVE_C99_VSNPRINTF=no ;;
esac
fi
rm -f core *.core core.conftest.* gmon.out bb.out conftest$ac_exeext \
  conftest.$ac_objext conftest.beam conftest.$ac_ext ;;
...
then :
  ...
  e) rsync_cv_HAVE_SECURE_MKSTEMP=no ;;
esac
fi
rm -f core *.core core.conftest.* gmon.out bb.out conftest$ac_exeext \
  conftest.$ac_objext conftest.beam conftest.$ac_ext ;;
...
then :
  ...
  e) samba_cv_HAVE_ACL_GET_PERM_NP=no ;;
esac
fi
rm -f core conftest.err conftest.$ac_objext conftest.beam \
    conftest$ac_exeext conftest.$ac_ext ;;
...
then :
  ...
  e) case "$ac_cv_func_getxattr$ac_cv_func_extattr_get_link$ac_cv_func_attropen" in
...
printf "%s\n" "#define NO_SYMLINK_USER_XATTRS 1" >>confdefs.h
	...
	{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: checking for library containing getxattr" >&5
printf %s "checking for library containing getxattr... " >&6; }
if test ${ac_cv_search_getxattr+y}
then :
  printf %s "(cached) " >&6
else case e in #(
  e) ac_func_search_save_LIBS=$LIBS
...
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: result: $ac_cv_search_getxattr" >&5
printf "%s\n" "$ac_cv_search_getxattr" >&6; }
...
if test x"$samba_cv_HAVE_POSIX_ACLS" = x"yes" \
   && { test x"$ac_cv_header_sys_xattr_h" = x"yes" || test x"$ac_cv_header_attr_xattr_h" = x"yes"; }; then
    case "$host_os" in
    *linux*)
	printf "%s\n" "#define SUPPORT_ACL_FD 1" >>confdefs.h

	{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: checking for SYS_setxattrat" >&5
printf %s "checking for SYS_setxattrat... " >&6; }
if test ${rsync_cv_have_sys_setxattrat+y}
then :
  printf %s "(cached) " >&6
else case e in #(
  e)
...
struct xattr_args a; a.value = 0; a.size = 0; a.flags = 0;
	  ...
	  syscall(SYS_removexattrat, 0, ".", 0, "n");
  ;
  return 0;
}
_ACEOF
if ac_fn_c_try_compile "$LINENO"
then :
  rsync_cv_have_sys_setxattrat=yes
else case e in #(
  e) rsync_cv_have_sys_setxattrat=no ;;
esac
fi
rm -f core conftest.err conftest.$ac_objext conftest.beam conftest.$ac_ext ;;
esac
fi
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: result: $rsync_cv_have_sys_setxattrat" >&5
printf "%s\n" "$rsync_cv_have_sys_setxattrat" >&6; }
	if test x"$rsync_cv_have_sys_setxattrat" = x"yes"; then
	    printf "%s\n" "#define HAVE_XATTRAT_SYSCALLS 1" >>confdefs.h
...
if test x"$samba_cv_HAVE_POSIX_ACLS" = x"yes"; then
    case "$host_os" in
    *linux*)
	{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: checking for acl_get_file_at in -lacl" >&5
printf %s "checking for acl_get_file_at in -lacl... " >&6; }
if test ${ac_cv_lib_acl_acl_get_file_at+y}
then :
  printf %s "(cached) " >&6
else case e in #(
  e) ac_check_lib_save_LIBS=$LIBS
...
extern "C"
#endif
char acl_get_file_at (void);
int
main (void)
{
return acl_get_file_at ();
  ;
  return 0;
}
_ACEOF
if ac_fn_c_try_link "$LINENO"
then :
  ac_cv_lib_acl_acl_get_file_at=yes
else case e in #(
  e) ac_cv_lib_acl_acl_get_file_at=no ;;
esac
fi
rm -f core conftest.err conftest.$ac_objext conftest.beam \
    conftest$ac_exeext conftest.$ac_ext
...
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: result: $ac_cv_lib_acl_acl_get_file_at" >&5
printf "%s\n" "$ac_cv_lib_acl_acl_get_file_at" >&6; }
if test "x$ac_cv_lib_acl_acl_get_file_at" = xyes
then :
  rsync_have_libacl_at=yes
else case e in #(
  e) rsync_have_libacl_at=no ;;
esac
fi

	if test x"$rsync_have_libacl_at" = x"yes"; then

  for ac_func in acl_set_file_at acl_delete_def_file_at
do :
...
_ACEOF
  ...
  e) rsync_have_libacl_at=no ;;
	...
	if test x"$rsync_have_libacl_at" = x"yes"; then
	    printf "%s\n" "#define HAVE_LIBACL_AT 1" >>confdefs.h
