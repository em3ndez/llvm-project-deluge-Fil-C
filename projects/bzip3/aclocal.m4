...
m4_include([build-aux/ax_build_date_epoch.m4])
m4_include([build-aux/ax_check_compile_flag.m4])
m4_include([build-aux/ax_progvar.m4])
m4_include([build-aux/ax_pthread.m4])
m4_include([build-aux/ax_subst_man_date.m4])
m4_include([build-aux/ax_subst_transformed_package_name.m4])
