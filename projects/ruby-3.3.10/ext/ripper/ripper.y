...
#else
#endif
} <val> <node_fcall> <node_args> <node_args_aux> <node_opt_arg> <node_kw_arg> <node_block_pass>
%printer {
#ifndef RIPPER
...
%token <val>   tIDENTIFIER    "local variable or method"
%token <val>   tFID           "method"
%token <val>   tGVAR          "global variable"
%token <val>   tIVAR          "instance variable"
%token <val>   tCONSTANT      "constant"
%token <val>   tCVAR          "class variable"
%token <val>   tLABEL         "label"
%token <val> tINTEGER       "integer literal"
%token <val> tFLOAT         "float literal"
%token <val> tRATIONAL      "rational literal"
%token <val> tIMAGINARY     "imaginary literal"
%token <val> tCHAR          "char literal"
%token <val> tNTH_REF       "numbered reference"
%token <val> tBACK_REF      "back reference"
%token <val> tSTRING_CONTENT "literal content"
%token <val>  tREGEXP_END
%token <val>  tDUMNY_END     "dummy end"
...
%type <val> literal numeric simple_numeric ssym dsym symbol cpath
/*ripper*/ %type <node_def_temp> defn_head defs_head k_def
/*ripper*/ %type <node_exits> block_open k_while k_until k_for allow_exits
%type <val> top_compstmt top_stmts top_stmt begin_block endless_arg endless_command
...
%type <val> opt_block_arg block_arg
%type <val> var_ref var_lhs
...
%type <val> f_arglist f_opt_paren_args f_paren_args f_args
%type <val> f_arg f_arg_item
%type <val> f_optarg
%type <val> f_marg f_marg_list f_rest_marg
%type <val> f_margs
%type <val> assoc_list assocs assoc undef_list backref string_dvar for_var
%type <val> block_param opt_block_param block_param_def
%type <val> f_opt
%type <val> f_kwarg f_kw f_block_kwarg f_block_kw
%type <val> bv_decls opt_bv_decl bvar
%type <val> lambda lambda_body brace_body do_body
%type <val> f_larglist
%type <val> brace_block cmd_brace_block do_block lhs none fitem
%type <val> mlhs_head mlhs_item mlhs_node mlhs_post
%type <val> mlhs mlhs_basic mlhs_inner
%type <val> p_case_body p_cases p_top_expr p_top_expr_body
%type <val> p_expr p_as p_alt p_expr_basic p_find
%type <val> p_args p_args_head p_args_tail p_args_post p_arg p_rest
%type <val> p_value p_primitive p_variable p_var_ref p_expr_ref p_const
%type <val> p_kwargs p_kwarg p_kw
%type <val>   keyword_variable user_variable sym operation operation2 operation3
%type <val>   cname fname op f_rest_arg f_block_arg opt_f_block_arg f_norm_arg f_bad_arg
%type <val>   f_kwrest f_label f_arg_asgn call_op call_op2 reswords relop dot_or_colon
%type <val>   p_kwrest p_kwnorest p_any_kwrest p_kw_label
%type <val>   f_no_kwarg f_any_kwrest args_forward excessed_comma nonlocal_var def_name
...
%token <val> '\t' 	"escaped horizontal tab"
%token <val> '\f'	"escaped form feed"
%token <val> '\r'	"escaped carriage return"
%token <val> '\13'	"escaped vertical tab"
...
%token tLSHFT		136 "<<"
%token tRSHFT		137 ">>"
%token <val> tANDDOT	150 "&."
%token <val> tCOLON2	147 "::"
%token tCOLON3		":: at EXPR_BEG"
%token <val> tOP_ASGN	"operator-assignment" /* +=, -=  etc. */
%token tASSOC		"=>"
%token tLPAREN		"("
...
#endif
			{VALUE v1,v2;v1=$2;v2=dispatch1(program,v1);p->result=v2;}
                        local_pop(p);
                    }
                ;
...
top_stmts	: none
                    {
                        ...
                        $$ = NEW_BEGIN(0, &@$);
#endif
			{VALUE v1,v2,v3,v4,v5;v1=dispatch0(stmts_new);v2=dispatch0(void_stmt);v3=v1;v4=v2;v5=dispatch2(stmts_add,v3,v4);$$=v5;}
                    }
                | top_stmt
                    {
#if 0
                        $$ = newline_node($1);
#endif
			{VALUE v1,v2,v3,v4;v1=dispatch0(stmts_new);v2=v1;v3=$1;v4=dispatch2(stmts_add,v2,v3);$$=v4;}
                    }
...
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$3;v3=dispatch2(stmts_add,v1,v2);$$=v3;}
                    }
                ;
...
begin_block	: block_open top_compstmt '}'
                    {
                        ...
                        $$ = NEW_BEGIN(0, &@$);
#endif
			{VALUE v1,v2;v1=$2;v2=dispatch1(BEGIN,v1);$$=v2;}
                    }
                ;
...
#endif
			{VALUE v1,v2,v3,v4,v5;v1=$body;v2=$opt_rescue;v3=$elsebody;v4=$opt_ensure;v5=dispatch4(bodystmt,v1,v2,v3,v4);$$=v5;}
                    }
                | compstmt[body]
                  lex_ctxt[ctxt]
                  opt_rescue
...
#endif
			{VALUE v1,v2,v3,v4,v5;v1=$body;v2=$opt_rescue;v3=Qnil;v4=$opt_ensure;v5=dispatch4(bodystmt,v1,v2,v3,v4);$$=v5;}
                    }
                ;
...
stmt		: keyword_alias fitem {SET_LEX_STATE(EXPR_FNAME|EXPR_FITEM);} fitem
                    {
                        ...
                        $$ = NEW_ALIAS($2, $4, &@$);
#endif
			{VALUE v1,v2,v3;v1=$2;v2=$4;v3=dispatch2(alias,v1,v2);$$=v3;}
                    }
                | keyword_alias tGVAR tGVAR
                    {
                        ...
                        $$ = NEW_VALIAS($2, $3, &@$);
#endif
			{VALUE v1,v2,v3;v1=$2;v2=$3;v3=dispatch2(var_alias,v1,v2);$$=v3;}
                    }
                ...
                | keyword_alias tGVAR tNTH_REF
                    {
                        ...
                        $$ = NEW_ERROR(&@$);
#endif
			{VALUE v1,v2,v3;v1=ERR_MESG();v2=$3;v3=dispatch2(alias_error,v1,v2);$$=v3;}ripper_error(p);
                    }
                | keyword_undef undef_list
                    {
                        ...
                        $$ = $2;
#endif
			{VALUE v1,v2;v1=$2;v2=dispatch1(undef,v1);$$=v2;}
                    }
                | stmt modifier_if expr_value
                    {
                        ...
                        fixpos($$, $3);
#endif
			{VALUE v1,v2,v3;v1=$3;v2=$1;v3=dispatch2(if_mod,v1,v2);$$=v3;}
                    }
                | stmt modifier_unless expr_value
                    {
                        ...
                        fixpos($$, $3);
#endif
			{VALUE v1,v2,v3;v1=$3;v2=$1;v3=dispatch2(unless_mod,v1,v2);$$=v3;}
                    }
...
#endif
			{VALUE v1,v2,v3;v1=$3;v2=$1;v3=dispatch2(while_mod,v1,v2);$$=v3;}
                    }
...
#endif
			{VALUE v1,v2,v3;v1=$3;v2=$1;v3=dispatch2(until_mod,v1,v2);$$=v3;}
                    }
...
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$4;v3=dispatch2(rescue_mod,v1,v2);$$=v3;}
                    }
...
#endif
			{VALUE v1,v2;v1=$compstmt;v2=dispatch1(END,v1);$$=v2;}
                    }
                | command_asgn
...
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$4;v3=dispatch2(massign,v1,v2);$$=v3;}
                    }
                | lhs '=' lex_ctxt mrhs
                    {
#if 0
                        $$ = node_assign(p, $1, $4, $3, &@$);
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$4;v3=dispatch2(assign,v1,v2);$$=v3;}
                    }
...
#endif
			{VALUE v1,v2,v3,v4,v5,v6;v1=$4;v2=$7;v3=dispatch2(rescue_mod,v1,v2);v4=$1;v5=v3;v6=dispatch2(massign,v4,v5);$$=v6;}
                    }
...
#endif
			{VALUE v1,v2,v3,v4;v1=$1;v2=$2;v3=$4;v4=dispatch3(opassign,v1,v2,v3);$$=v4;}
                    }
...
#endif
			{VALUE v1,v2,v3,v4,v5,v6,v7;v1=$1;v2=$3;v3=dispatch2(aref_field,v1,v2);v4=v3;v5=$5;v6=$7;v7=dispatch3(opassign,v4,v5,v6);$$=v7;}
...
#endif
			{VALUE v1,v2,v3,v4,v5,v6,v7;v1=$1;v2=$3;v3=dispatch2(const_path_field,v1,v2);v4=v3;v5=$4;v6=$6;v7=dispatch3(opassign,v4,v5,v6);$$=v7;}
                    }
...
#endif
			{VALUE v1,v2,v3,v4,v5;v1=$bodystmt;v2=Qnil;v3=Qnil;v4=Qnil;v5=dispatch4(bodystmt,v1,v2,v3,v4);$bodystmt=v5;}
			{VALUE v1,v2,v3,v4;v1=$head->nd_mid;v2=$args;v3=$bodystmt;v4=dispatch3(def,v1,v2,v3);$$=v4;}
                        local_pop(p);
                    }
...
#endif
			{VALUE v1,v2,v3,v4,v5;v1=$bodystmt;v2=Qnil;v3=Qnil;v4=Qnil;v5=dispatch4(bodystmt,v1,v2,v3,v4);$bodystmt=v5;}
			{VALUE v1,v2,v3,v4,v5,v6;v1=$head->nd_recv;v2=$head->dot_or_colon;v3=$head->nd_mid;v4=$args;v5=$bodystmt;v6=dispatch5(defs,v1,v2,v3,v4,v5);$$=v6;}
                        local_pop(p);
                    }
                | backref tOP_ASGN lex_ctxt command_rhs
                    {
                        ...
                        $$ = NEW_ERROR(&@$);
#endif
			{VALUE v1,v2,v3;v1=var_field(p, $1);v2=$4;v3=dispatch2(assign,v1,v2);$$=backref_error(p, RNODE($1), v3);}ripper_error(p);
                    }
                ;
...
#endif
			{VALUE v1,v2,v3,v4,v5,v6,v7;v1=$body;v2=Qnil;v3=Qnil;v4=dispatch3(in,v1,v2,v3);v5=$arg;v6=v4;v7=dispatch2(case,v5,v6);$$=v7;}
                    }
                | arg keyword_in
                    {
                        value_expr($arg);
...
command		: fcall command_args       %prec tLOWEST
                    {
                        ...
                        $$ = (NODE *)$1;
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$2;v3=dispatch2(command,v1,v2);$$=v3;}
                    }
                | fcall command_args cmd_brace_block
                    {
                        ...
                        nd_set_last_loc($1, @2.end_pos);
#endif
			{VALUE v1,v2,v3,v4,v5,v6;v1=$1;v2=$2;v3=dispatch2(command,v1,v2);v4=v3;v5=$3;v6=dispatch2(method_add_block,v4,v5);$$=v6;}
                    }
...
#endif
			{VALUE v1,v2,v3,v4,v5,v6,v7,v8;v1=$1;v2=$2;v3=$3;v4=Qnull;v5=dispatch4(command_call,v1,v2,v3,v4);v6=v5;v7=$5;v8=dispatch2(method_add_block,v6,v7);$$=v8;}
                   }
                | keyword_super command_args
                    {
                        ...
                        fixpos($$, $2);
#endif
			{VALUE v1,v2;v1=$2;v2=dispatch1(super,v1);$$=v2;}
                    }
                | k_yield command_args
                    {
                        ...
                        fixpos($$, $2);
#endif
			{VALUE v1,v2;v1=$2;v2=dispatch1(yield,v1);$$=v2;}
                    }
                | k_return call_args
                    {
#if 0
...
#endif
			{VALUE v1,v2;v1=$2;v2=dispatch1(return,v1);$$=v2;}
                    }
			...
			{VALUE v1,v2;v1=$2;v2=dispatch1(break,v1);$$=v2;}
                    }
			...
			{VALUE v1,v2;v1=$2;v2=dispatch1(next,v1);$$=v2;}
                    }
                ;
                ...
                | tLPAREN mlhs_inner rparen
                    {
                        ...
                        $$ = $2;
#endif
			{VALUE v1,v2;v1=$2;v2=dispatch1(mlhs_paren,v1);$$=v2;}
                    }
                ;
...
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$2;v3=dispatch2(mlhs_add,v1,v2);$$=v3;}
                    }
                | mlhs_head tSTAR mlhs_node
                    {
                        ...
                        $$ = NEW_MASGN($1, $3, &@$);
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$3;v3=dispatch2(mlhs_add_star,v1,v2);$$=v3;}
                    }
...
#endif
			{VALUE v1,v2,v3,v4,v5,v6;v1=$1;v2=$3;v3=dispatch2(mlhs_add_star,v1,v2);v4=v3;v5=$5;v6=dispatch2(mlhs_add_post,v4,v5);$$=v6;}
                    }
                | mlhs_head tSTAR
                    {
#if 0
...
#endif
			{VALUE v1,v2,v3;v1=$1;v2=Qnil;v3=dispatch2(mlhs_add_star,v1,v2);$$=v3;}
                    }
...
#endif
			{VALUE v1,v2,v3,v4,v5,v6;v1=$1;v2=Qnil;v3=dispatch2(mlhs_add_star,v1,v2);v4=v3;v5=$4;v6=dispatch2(mlhs_add_post,v4,v5);$$=v6;}
                    }
                | tSTAR mlhs_node
                    {
#if 0
                        $$ = NEW_MASGN(0, $2, &@$);
#endif
			{VALUE v1,v2,v3,v4;v1=dispatch0(mlhs_new);v2=v1;v3=$2;v4=dispatch2(mlhs_add_star,v2,v3);$$=v4;}
                    }
...
#endif
			{VALUE v1,v2,v3,v4,v5,v6,v7;v1=dispatch0(mlhs_new);v2=v1;v3=$2;v4=dispatch2(mlhs_add_star,v2,v3);v5=v4;v6=$4;v7=dispatch2(mlhs_add_post,v5,v6);$$=v7;}
                    }
                | tSTAR
                    {
#if 0
...
#endif
			{VALUE v1,v2,v3,v4;v1=dispatch0(mlhs_new);v2=v1;v3=Qnil;v4=dispatch2(mlhs_add_star,v2,v3);$$=v4;}
                    }
                | tSTAR ',' mlhs_post
                    {
#if 0
...
#endif
			{VALUE v1,v2,v3,v4,v5,v6,v7;v1=dispatch0(mlhs_new);v2=v1;v3=Qnil;v4=dispatch2(mlhs_add_star,v2,v3);v5=v4;v6=$3;v7=dispatch2(mlhs_add_post,v5,v6);$$=v7;}
                    }
                ;
...
mlhs_head	: mlhs_item ','
                    {
                        ...
                        $$ = NEW_LIST($1, &@1);
#endif
			{VALUE v1,v2,v3,v4;v1=dispatch0(mlhs_new);v2=v1;v3=$1;v4=dispatch2(mlhs_add,v2,v3);$$=v4;}
                    }
                | mlhs_head mlhs_item ','
                    {
#if 0
                ...
                | mlhs_post ',' mlhs_item
                    {
                        ...
                        $$ = list_append(p, $1, $3);
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$3;v3=dispatch2(mlhs_add,v1,v2);$$=v3;}
                    }
                ;
                ...
                | primary_value '[' opt_call_args rbracket
                    {
                        ...
                        $$ = aryset(p, $1, $3, &@$);
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$3;v3=dispatch2(aref_field,v1,v2);$$=v3;}
                    }
                | primary_value call_op tIDENTIFIER
                    {
                        ...
                        $$ = attrset(p, $1, $2, $3, &@$);
#endif
			{VALUE v1,v2,v3,v4;v1=$1;v2=$2;v3=$3;v4=dispatch3(field,v1,v2,v3);$$=v4;}
                    }
...
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$3;v3=dispatch2(const_path_field,v1,v2);$$=v3;}
                    }
...
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$3;v3=dispatch2(const_path_field,v1,v2);$$=const_decl(p, v3);}
                    }
                | tCOLON3 tCONSTANT
                    {
#if 0
...
#endif
			{VALUE v1,v2;v1=$2;v2=dispatch1(top_const_field,v1);$$=const_decl(p, v2);}
                    }
                | backref
                    {
#if 0
                        ...
                        $$ = NEW_ERROR(&@$);
#endif
			$$=backref_error(p, RNODE($1), var_field(p, $1));ripper_error(p);
                    }
                ;
...
cname		: tIDENTIFIER
                    {
                        ...
                        yyerror1(&@1, mesg);
#endif
			{VALUE v1,v2,v3;v1=ERR_MESG();v2=$1;v3=dispatch2(class_name_error,v1,v2);$$=v3;}ripper_error(p);
                    }
                | tCONSTANT
                ;
...
cpath		: tCOLON3 cname
                    {
                        ...
                        $$ = NEW_COLON3($2, &@$);
#endif
			{VALUE v1,v2;v1=$2;v2=dispatch1(top_const_ref,v1);$$=v2;}
                    }
                | cname
                    {
#if 0
                        $$ = NEW_COLON2(0, $1, &@$);
#endif
			{VALUE v1,v2;v1=$1;v2=dispatch1(const_ref,v1);$$=v2;}
                    }
                | primary_value tCOLON2 cname
                    {
                        ...
                        $$ = NEW_COLON2($1, $3, &@$);
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$3;v3=dispatch2(const_path_ref,v1,v2);$$=v3;}
                    }
                ;
...
fitem		: fname
                    {
                        ...
                        $$ = NEW_LIT(ID2SYM($1), &@$);
#endif
			{VALUE v1,v2;v1=$1;v2=dispatch1(symbol_literal,v1);$$=v2;}
                    }
                | symbol
                ;
...
#endif
			{VALUE v1,v2,v3,v4,v5,v6;v1=$2;v2=dispatch1(top_const_field,v1);v3=v2;v4=$3;v5=$5;v6=dispatch3(opassign,v3,v4,v5);$$=v6;}
                    }
                | backref tOP_ASGN lex_ctxt arg_rhs
                    {
                        ...
                        $$ = NEW_ERROR(&@$);
#endif
			{VALUE v1,v2,v3,v4;v1=var_field(p, $1);v2=$2;v3=$4;v4=dispatch3(opassign,v1,v2,v3);$$=backref_error(p, RNODE($1), v4);}ripper_error(p);
                    }
                | arg tDOT2 arg
                    {
#if 0
                        ...
                        $$ = NEW_DOT2($1, $3, &@$);
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$3;v3=dispatch2(dot2,v1,v2);$$=v3;}
                    }
                | arg tDOT3 arg
                    {
#if 0
                        ...
                        $$ = NEW_DOT3($1, $3, &@$);
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$3;v3=dispatch2(dot3,v1,v2);$$=v3;}
                    }
                | arg tDOT2
                    {
#if 0
...
#endif
			{VALUE v1,v2,v3;v1=$1;v2=Qnil;v3=dispatch2(dot2,v1,v2);$$=v3;}
                    }
                | arg tDOT3
                    {
#if 0
...
#endif
			{VALUE v1,v2,v3;v1=$1;v2=Qnil;v3=dispatch2(dot3,v1,v2);$$=v3;}
                    }
                | tBDOT2 arg
                    {
#if 0
...
#endif
			{VALUE v1,v2,v3;v1=Qnil;v2=$2;v3=dispatch2(dot2,v1,v2);$$=v3;}
                    }
                | tBDOT3 arg
                    {
#if 0
...
#endif
			{VALUE v1,v2,v3;v1=Qnil;v2=$2;v3=dispatch2(dot3,v1,v2);$$=v3;}
                    }
                | arg '+' arg
                    {
                        $$ = call_bin_op(p, $1, '+', $3, &@2, &@$);
                ...
                | arg '?' arg opt_nl ':' arg
                    {
                        ...
                        fixpos($$, $1);
#endif
			{VALUE v1,v2,v3,v4;v1=$1;v2=$3;v3=$6;v4=dispatch3(ifop,v1,v2,v3);$$=v4;}
                    }
...
#endif
			{VALUE v1,v2,v3,v4,v5;v1=$3;v2=dispatch1(bare_assoc_hash,v1);v3=$1;v4=v2;v5=dispatch2(args_add,v3,v4);$$=v5;}
                    }
                | assocs trailer
                    {
#if 0
...
#endif
			{VALUE v1,v2,v3,v4,v5,v6;v1=dispatch0(args_new);v2=$1;v3=dispatch1(bare_assoc_hash,v2);v4=v1;v5=v3;v6=dispatch2(args_add,v4,v5);$$=v6;}
                    }
                ;
...
paren_args	: '(' opt_call_args rparen
                    {
                        ...
                        $$ = $2;
#endif
			{VALUE v1,v2;v1=$2;v2=dispatch1(arg_paren,v1);$$=v2;}
                    }
                ...
                | args opt_block_arg
                    {
                        ...
                        $$ = arg_blk_pass($1, $2);
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$2;v3=dispatch2(args_add_block,v1,v2);$$=v3;}
                    }
                | assocs opt_block_arg
                    {
                        ...
                        $$ = arg_blk_pass($$, $2);
#endif
			{VALUE v1,v2,v3,v4,v5,v6,v7,v8,v9;v1=dispatch0(args_new);v2=$1;v3=dispatch1(bare_assoc_hash,v2);v4=v1;v5=v3;v6=dispatch2(args_add,v4,v5);v7=v6;v8=$2;v9=dispatch2(args_add_block,v7,v8);$$=v9;}
                    }
                | args ',' assocs opt_block_arg
                    {
                        ...
                        $$ = arg_blk_pass($$, $4);
#endif
			{VALUE v1,v2,v3,v4,v5,v6,v7,v8;v1=$3;v2=dispatch1(bare_assoc_hash,v1);v3=$1;v4=v2;v5=dispatch2(args_add,v3,v4);v6=v5;v7=$4;v8=dispatch2(args_add_block,v6,v7);$$=v8;}
                    }
                | block_arg
			{{VALUE v1,v2,v3,v4;v1=dispatch0(args_new);v2=v1;v3=$1;v4=dispatch2(args_add_block,v2,v3);$$=v4;}}
                ;
...
mrhs		: args ',' arg_value
                    {
                        ...
                        $$ = last_arg_append(p, $1, $3, &@$);
#endif
			{VALUE v1,v2,v3,v4,v5;v1=$1;v2=dispatch1(mrhs_new_from_args,v1);v3=v2;v4=$3;v5=dispatch2(mrhs_add,v3,v4);$$=v5;}
                    }
...
#endif
			{VALUE v1,v2,v3,v4,v5;v1=$1;v2=dispatch1(mrhs_new_from_args,v1);v3=v2;v4=$4;v5=dispatch2(mrhs_add_star,v3,v4);$$=v5;}
                    }
                | tSTAR arg_value
                    {
#if 0
                        $$ = NEW_SPLAT($2, &@$);
#endif
			{VALUE v1,v2,v3,v4;v1=dispatch0(mrhs_new);v2=v1;v3=$2;v4=dispatch2(mrhs_add_star,v2,v3);$$=v4;}
                    }
                ;
...
primary		: literal
                ...
                | tFID
                    {
                        ...
                        $$ = (NODE *)NEW_FCALL($1, 0, &@$);
#endif
			{VALUE v1,v2,v3,v4,v5,v6;v1=$1;v2=dispatch1(fcall,v1);v3=dispatch0(args_new);v4=v2;v5=v3;v6=dispatch2(method_add_arg,v4,v5);$$=v6;}
                    }
                | k_begin
                    {
                        CMDARG_PUSH(0);
...
#endif
			{VALUE v1,v2;v1=$3;v2=dispatch1(begin,v1);$$=v2;}
                    }
                ...
                | tLBRACK aref_args ']'
                    {
                        ...
                        $$ = make_list($2, &@$);
#endif
			{VALUE v1,v2;v1=$2;v2=dispatch1(array,v1);$$=v2;}
                    }
                | tLBRACE assoc_list '}'
                    {
#if 0
...
#endif
			{VALUE v1,v2;v1=$2;v2=dispatch1(hash,v1);$$=v2;}
                    }
                | k_return
                    {
#if 0
                        $$ = NEW_RETURN(0, &@$);
#endif
			{VALUE v1;v1=dispatch0(return0);$$=v1;}
                    }
                | k_yield '(' call_args rparen
                    {
                        ...
                        $$ = new_yield(p, $3, &@$);
#endif
			{VALUE v1,v2,v3,v4;v1=$3;v2=dispatch1(paren,v1);v3=v2;v4=dispatch1(yield,v3);$$=v4;}
                    }
                | k_yield '(' rparen
                    {
#if 0
                        $$ = NEW_YIELD(0, &@$);
#endif
			{VALUE v1,v2,v3,v4,v5;v1=dispatch0(args_new);v2=v1;v3=dispatch1(paren,v2);v4=v3;v5=dispatch1(yield,v4);$$=v5;}
                    }
                | k_yield
                    {
#if 0
                        $$ = NEW_YIELD(0, &@$);
#endif
			{VALUE v1;v1=dispatch0(yield0);$$=v1;}
                    }
...
#endif
			{VALUE v1,v2,v3,v4,v5,v6,v7,v8,v9;v1=$1;v2=dispatch1(fcall,v1);v3=dispatch0(args_new);v4=v2;v5=v3;v6=dispatch2(method_add_arg,v4,v5);v7=v6;v8=$2;v9=dispatch2(method_add_block,v7,v8);$$=v9;}
                    }
                | method_call
...
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$2;v3=dispatch2(method_add_block,v1,v2);$$=v3;}
                    }
                | lambda
                  ...
                  k_end
                    {
                        ...
                        fixpos($$, $2);
#endif
			{VALUE v1,v2,v3,v4;v1=$2;v2=$4;v3=$5;v4=dispatch3(if,v1,v2,v3);$$=v4;}
                    }
                  ...
                  k_end
                    {
                        ...
                        fixpos($$, $2);
#endif
			{VALUE v1,v2,v3,v4;v1=$2;v2=$4;v3=$5;v4=dispatch3(unless,v1,v2,v3);$$=v4;}
                    }
                  ...
                  k_end
                    {
                        ...
                        fixpos($$, $2);
#endif
			{VALUE v1,v2,v3;v1=$2;v2=$3;v3=dispatch2(while,v1,v2);$$=v3;}
                    }
                  ...
                  k_end
                    {
                        ...
                        fixpos($$, $2);
#endif
			{VALUE v1,v2,v3;v1=$2;v2=$3;v3=dispatch2(until,v1,v2);$$=v3;}
                    }
                  ...
                  k_end
                    {
                        ...
                        fixpos($$, $2);
#endif
			{VALUE v1,v2,v3;v1=$2;v2=$5;v3=dispatch2(case,v1,v2);$$=v3;}
                    }
                | k_case opt_terms
                    {
                        $<val>$ = p->case_labels;
                  ...
                  k_end
                    {
                        ...
                        $$ = NEW_CASE2($4, &@$);
#endif
			{VALUE v1,v2,v3;v1=Qnil;v2=$4;v3=dispatch2(case,v1,v2);$$=v3;}
                    }
                | k_case expr_value opt_terms
                  p_case_body
                  k_end
                    {
                        ...
                        $$ = NEW_CASE3($2, $4, &@$);
#endif
			{VALUE v1,v2,v3;v1=$2;v2=$4;v3=dispatch2(case,v1,v2);$$=v3;}
                    }
                  ...
                  k_end
                    {
                        ...
                        fixpos($$, $2);
#endif
			{VALUE v1,v2,v3,v4;v1=$2;v2=$4;v3=$5;v4=dispatch3(for,v1,v2,v3);$$=v4;}
                    }
...
#endif
			{VALUE v1,v2,v3,v4;v1=$cpath;v2=$superclass;v3=$bodystmt;v4=dispatch3(class,v1,v2,v3);$$=v4;}
                        local_pop(p);
                  ...
                  k_end
                    {
                        ...
                        fixpos($$, $expr_value);
#endif
			{VALUE v1,v2,v3;v1=$expr_value;v2=$bodystmt;v3=dispatch2(sclass,v1,v2);$$=v3;}
                        local_pop(p);
...
#endif
			{VALUE v1,v2,v3;v1=$cpath;v2=$bodystmt;v3=dispatch2(module,v1,v2);$$=v3;}
                        local_pop(p);
			...
			{VALUE v1,v2,v3;v1=dispatch0(args_new);v2=v1;v3=dispatch1(break,v2);$$=v3;}
                    }
                | keyword_next
                    {
                        $<node>$ = add_block_exit(p, NEW_NEXT(0, &@$));
			{VALUE v1,v2,v3;v1=dispatch0(args_new);v2=v1;v3=dispatch1(next,v2);$$=v3;}
                    }
                | keyword_redo
                    {
                        $<node>$ = add_block_exit(p, NEW_REDO(&@$));
			{VALUE v1;v1=dispatch0(redo);$$=v1;}
                    }
                | keyword_retry
                    {
                        if (!p->ctxt.in_defined) {
                        ...
                        $$ = NEW_RETRY(&@$);
#endif
			{VALUE v1;v1=dispatch0(retry);$$=v1;}
                    }
                ;
                  ...
                  if_tail
                    {
                        ...
                        fixpos($$, $2);
#endif
			{VALUE v1,v2,v3,v4;v1=$2;v2=$4;v3=$5;v4=dispatch3(elsif,v1,v2,v3);$$=v4;}
                    }
                ;
                ...
                | k_else compstmt
                    {
                        ...
                        $$ = $2;
#endif
			{VALUE v1,v2;v1=$2;v2=dispatch1(else,v1);$$=v2;}
                    }
                ;
                ...
                | f_rest_marg
                    {
                        ...
                        $$ = NEW_MASGN(0, $1, &@$);
#endif
			{VALUE v1,v2,v3,v4;v1=dispatch0(mlhs_new);v2=v1;v3=$1;v4=dispatch2(mlhs_add_star,v2,v3);$$=v4;}
                    }
...
#endif
			{VALUE v1,v2,v3,v4,v5,v6,v7;v1=dispatch0(mlhs_new);v2=v1;v3=$1;v4=dispatch2(mlhs_add_star,v2,v3);v5=v4;v6=$3;v7=dispatch2(mlhs_add_post,v5,v6);$$=v7;}
                    }
                ;
...
#endif
			{VALUE v1;v1=dispatch0(excessed_comma);$$=v1;}
                    }
                ;
...
block_param_def	: '|' opt_bv_decl '|'
                    {
                        ...
                        $$ = 0;
#endif
			{VALUE v1,v2,v3,v4,v5,v6,v7,v8;v1=Qnil;v2=Qnil;v3=Qnil;v4=Qnil;v5=Qnil;v6=Qnil;v7=Qnil;v8=dispatch7(params,v1,v2,v3,v4,v5,v6,v7);$$=v8;}
			{VALUE v1,v2,v3;v1=$$;v2=$2;v3=dispatch2(block_var,v1,v2);$$=v3;}
                    }
                | '|' block_param opt_bv_decl '|'
                    {
                        ...
                        $$ = $2;
#endif
			{VALUE v1,v2,v3;v1=$2;v2=$3;v3=dispatch2(block_var,v1,v2);$$=v3;}
                    }
                ;
...
#endif
			{VALUE v1,v2,v3;v1=$args;v2=$body;v3=dispatch2(lambda,v1,v2);$$=v3;}
                ...
                | block_call call_op2 operation2 opt_paren_args
                    {
                        ...
                        $$ = new_qcall(p, $2, $1, $3, $4, &@3, &@$);
#endif
			{VALUE v1,v2,v3,v4,v5,v6,v7;v1=$1;v2=$2;v3=$3;v4=dispatch3(call,v1,v2,v3);v5=v4;v6=$4;v7=v6==Qundef ? v5 : dispatch2(method_add_arg,v5,v6);$$=v7;}
                    }
                | block_call call_op2 operation2 opt_paren_args brace_block
                    {
                        ...
                        $$ = new_command_qcall(p, $2, $1, $3, $4, $5, &@3, &@$);
#endif
			{VALUE v1,v2,v3,v4,v5,v6,v7,v8;v1=$1;v2=$2;v3=$3;v4=$4;v5=dispatch4(command_call,v1,v2,v3,v4);v6=v5;v7=$5;v8=v7==Qundef ? v6 : dispatch2(method_add_block,v6,v7);$$=v8;}
                    }
...
method_call	: fcall paren_args
                    {
                        ...
                        nd_set_last_loc($1, @2.end_pos);
#endif
			{VALUE v1,v2,v3,v4,v5;v1=$1;v2=dispatch1(fcall,v1);v3=v2;v4=$2;v5=dispatch2(method_add_arg,v3,v4);$$=v5;}
                    }
                ...
                | keyword_super
                    {
                        ...
                        $$ = NEW_ZSUPER(&@$);
#endif
			{VALUE v1;v1=dispatch0(zsuper);$$=v1;}
                    }
                | primary_value '[' opt_call_args rbracket
                    {
#if 0
                        ...
                        fixpos($$, $1);
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$3;v3=dispatch2(aref,v1,v2);$$=v3;}
                    }
                ;
...
#endif
			{VALUE v1,v2,v3;v1=$args;v2=$compstmt;v3=dispatch2(brace_block,v1,v2);$$=v3;}
                        restore_block_exit(p, $allow_exits);
                        numparam_pop(p, $numparam);
                        dyna_pop(p, $<vars>dyna);
                    }
...
#endif
			{VALUE v1,v2,v3;v1=$args;v2=$bodystmt;v3=dispatch2(do_block,v1,v2);$$=v3;}
                        CMDARG_POP();
                        restore_block_exit(p, $allow_exits);
                        numparam_pop(p, $numparam);
                        dyna_pop(p, $<vars>dyna);
                  ...
                  cases
                    {
                        ...
                        fixpos($$, $2);
#endif
			{VALUE v1,v2,v3,v4;v1=$2;v2=$4;v3=$5;v4=dispatch3(when,v1,v2,v3);$$=v4;}
                    }
                ;
...
#endif
			{VALUE v1,v2,v3,v4;v1=$expr;v2=$compstmt;v3=$cases;v4=dispatch3(in,v1,v2,v3);$$=v4;}
                    }
                ;
...
p_as		: p_expr tASSOC p_variable
                    {
                        ...
                        $$ = new_hash(p, n, &@$);
#endif
			{VALUE v1,v2,v3,v4;v1=$1;v2=STATIC_ID2SYM(id_assoc);v3=$3;v4=dispatch3(binary,v1,v2,v3);$$=v4;}
                    }
                | p_alt
                ;
...
p_alt		: p_alt '|' p_expr_basic
                    {
                        ...
                        $$ = NEW_OR($1, $3, &@$);
#endif
			{VALUE v1,v2,v3,v4;v1=$1;v2=STATIC_ID2SYM(idOr);v3=$3;v4=dispatch3(binary,v1,v2,v3);$$=v4;}
                    }
                | p_expr_basic
                ;
...
p_arg		: p_expr
                    {
                        ...
                        $$ = NEW_LIST($1, &@$);
#endif
			$$=rb_ary_new_from_args(1, get_value($1));
                    }
                ;
...
#endif
			$$=rb_ary_new_from_args(2, get_value($1), get_value($2));
                    }
                | p_kw_label
                    {
                        error_duplicate_pattern_key(p, get_id($1), &@1);
...
#endif
			$$=rb_ary_new_from_args(2, get_value(assignable(p, $1)), Qnil);
                    }
                ;
...
#endif
			{VALUE v1,v2;v1=$1;v2=dispatch1(var_ref,v1);$$=v2;}
                    }
                | lambda
                ;
...
p_var_ref	: '^' tIDENTIFIER
                    {
                        ...
                        $$ = n;
#endif
			{VALUE v1,v2;v1=$2;v2=dispatch1(var_ref,v1);$$=v2;}
                    }
                | '^' nonlocal_var
                    {
#if 0
...
#endif
			{VALUE v1,v2,v3,v4,v5;v1=$2;v2=$3;v3=$5;v4=$6;v5=dispatch4(rescue,v1,v2,v3,v4);$$=v5;}
                    }
                | none
                ;
...
opt_ensure	: k_ensure compstmt
                    {
                        ...
                        $$ = $2;
#endif
			{VALUE v1,v2;v1=$2;v2=dispatch1(ensure,v1);$$=v2;}
                    }
                | none
                ;
...
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$2;v3=dispatch2(string_concat,v1,v2);$$=v3;}
                    }
                ;
...
string1		: tSTRING_BEG string_contents tSTRING_END
                    {
                        ...
                        if ($$) nd_set_loc($$, &@$);
#endif
			{VALUE v1,v2;v1=heredoc_dedent(p, $2);v2=dispatch1(string_literal,v1);$$=v2;}
                    }
                ;
...
#endif
			{VALUE v1,v2;v1=heredoc_dedent(p, $2);v2=dispatch1(xstring_literal,v1);$$=v2;}
                    }
                ;
...
words		: tWORDS_BEG words_sep word_list tSTRING_END
                    {
                        ...
                        $$ = make_list($3, &@$);
#endif
			{VALUE v1,v2;v1=$3;v2=dispatch1(array,v1);$$=v2;}
                    }
                ;
...
word_list	: /* none */
                    {
                        ...
                        $$ = 0;
#endif
			{VALUE v1;v1=dispatch0(words_new);$$=v1;}
                    }
...
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$2;v3=dispatch2(words_add,v1,v2);$$=v3;}
                    }
                ;

word		: string_content
			{{VALUE v1,v2,v3,v4;v1=dispatch0(word_new);v2=v1;v3=$1;v4=dispatch2(word_add,v2,v3);$$=v4;}}
                | word string_content
                    {
#if 0
                        $$ = literal_concat(p, $1, $2, &@$);
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$2;v3=dispatch2(word_add,v1,v2);$$=v3;}
                    }
                ;
...
symbol_list	: /* none */
                    {
                        ...
                        $$ = 0;
#endif
			{VALUE v1;v1=dispatch0(symbols_new);$$=v1;}
                    }
...
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$2;v3=dispatch2(symbols_add,v1,v2);$$=v3;}
                    }
                ;
...
qword_list	: /* none */
                    {
                        ...
                        $$ = 0;
#endif
			{VALUE v1;v1=dispatch0(qwords_new);$$=v1;}
                    }
                | qword_list tSTRING_CONTENT words_sep
                    {
                        ...
                        $$ = list_append(p, $1, $2);
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$2;v3=dispatch2(qwords_add,v1,v2);$$=v3;}
                    }
                ;
...
qsym_list	: /* none */
                    {
                        ...
                        $$ = 0;
#endif
			{VALUE v1;v1=dispatch0(qsymbols_new);$$=v1;}
                    }
                | qsym_list tSTRING_CONTENT words_sep
                    {
                        ...
                        $$ = symbol_append(p, $1, $2);
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$2;v3=dispatch2(qsymbols_add,v1,v2);$$=v3;}
                    }
                ;
...
string_contents : /* none */
                    {
                        ...
                        $$ = 0;
#endif
			{VALUE v1;v1=dispatch0(string_content);$$=v1;}
#if 0
#endif
                ...
                | string_contents string_content
                    {
                        ...
                        $$ = literal_concat(p, $1, $2, &@$);
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$2;v3=dispatch2(string_add,v1,v2);$$=v3;}
#if 0
#endif
...
xstring_contents: /* none */
                    {
                        ...
                        $$ = 0;
#endif
			{VALUE v1;v1=dispatch0(xstring_new);$$=v1;}
                    }
                | xstring_contents string_content
                    {
                        ...
                        $$ = literal_concat(p, $1, $2, &@$);
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$2;v3=dispatch2(xstring_add,v1,v2);$$=v3;}
                    }
                ;
...
regexp_contents: /* none */
                    {
                        ...
                        $$ = 0;
#endif
			{VALUE v1;v1=dispatch0(regexp_new);$$=v1;}
#if 0
#endif
                        $$ = ripper_new_yylval(p, 0, $$, 0);
...
string_content	: tSTRING_CONTENT
			{$$=ripper_new_yylval(p, 0, get_value($1), $1);}
                | tSTRING_DVAR
                    {
                  ...
                  string_dvar
                    {
                        ...
                        nd_set_line($$, @3.end_pos.lineno);
#endif
			{VALUE v1,v2;v1=$3;v2=dispatch1(string_dvar,v1);$$=v2;}
                    }
                | tSTRING_DBEG[term]
                    {
                        CMDARG_PUSH(0);
...
#endif
			{VALUE v1,v2;v1=$compstmt;v2=dispatch1(string_embexpr,v1);$$=v2;}
                    }
                ;
...
ssym		: tSYMBEG sym
                    {
                        ...
                        $$ = NEW_LIT(ID2SYM($2), &@$);
#endif
			{VALUE v1,v2,v3,v4;v1=$2;v2=dispatch1(symbol,v1);v3=v2;v4=dispatch1(symbol_literal,v3);$$=v4;}
                    }
                ;
...
dsym		: tSYMBEG string_contents tSTRING_END
                    {
                        ...
                        $$ = dsym_node(p, $2, &@$);
#endif
			{VALUE v1,v2;v1=$2;v2=dispatch1(dyna_symbol,v1);$$=v2;}
                    }
                ;
...
#endif
			{VALUE v1,v2,v3;v1=ID2VAL(idUMinus);v2=$2;v3=dispatch2(unary,v1,v2);$$=v3;}
                    }
                ;
...
#endif
#endif
			{VALUE v1;v1=dispatch0(args_forward);$$=v1;}
                    }
                ;
...
f_bad_arg	: tCONSTANT
                    {
                        ...
                        $$ = 0;
#endif
			{VALUE v1,v2,v3;v1=ERR_MESG();v2=$1;v3=dispatch2(param_error,v1,v2);$$=v3;}ripper_error(p);
                    }
                | tIVAR
                    {
...
#endif
			$$=rb_assoc_new(get_value(assignable(p, $1)), get_value($2));
                    }
                | f_label
                    {
                        p->cur_arg = 0;
...
#endif
			$$=rb_assoc_new(get_value(assignable(p, $1)), 0);
                    }
                ;
...
#if 0
#endif
			{VALUE v1,v2;v1=Qnil;v2=dispatch1(nokw_param,v1);$$=v2;}
                    }
                ;
...
f_kwrest	: kwrest_mark tIDENTIFIER
                    {
                        ...
                        $$ = $2;
#endif
			{VALUE v1,v2;v1=$2;v2=dispatch1(kwrest_param,v1);$$=v2;}
                    }
                | kwrest_mark
                    {
                        ...
                        $$ = idFWD_KWREST;
#endif
			{VALUE v1,v2;v1=Qnil;v2=dispatch1(kwrest_param,v1);$$=v2;}
                    }
                ;
...
#endif
			$$=rb_assoc_new(get_value(assignable(p, $1)), get_value($3));
                    }
                ;
...
f_rest_arg	: restarg_mark tIDENTIFIER
                    {
                        ...
                        $$ = $2;
#endif
			{VALUE v1,v2;v1=$2;v2=dispatch1(rest_param,v1);$$=v2;}
                    }
                | restarg_mark
                    {
                        ...
                        $$ = idFWD_REST;
#endif
			{VALUE v1,v2;v1=Qnil;v2=dispatch1(rest_param,v1);$$=v2;}
                    }
                ;
...
f_block_arg	: blkarg_mark tIDENTIFIER
                    {
                        ...
                        $$ = $2;
#endif
			{VALUE v1,v2;v1=$2;v2=dispatch1(blockarg,v1);$$=v2;}
                    }
                | blkarg_mark
                    {
                        ...
                        $$ = idFWD_BLOCK;
#endif
			{VALUE v1,v2;v1=Qnil;v2=dispatch1(blockarg,v1);$$=v2;}
                    }
                ;
                ...
                | '(' {SET_LEX_STATE(EXPR_BEG);} expr rparen
                    {
                        ...
                        $$ = $3;
#endif
			{VALUE v1,v2;v1=$3;v2=dispatch1(paren,v1);$$=v2;}
                    }
                ;
...
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$3;v3=dispatch2(assoc_new,v1,v2);$$=v3;}
                    }
                | tLABEL arg_value
                    {
#if 0
                        $$ = list_append(p, NEW_LIST(NEW_LIT(ID2SYM($1), &@1), &@$), $2);
#endif
			{VALUE v1,v2,v3;v1=$1;v2=$2;v3=dispatch2(assoc_new,v1,v2);$$=v3;}
                    }
                | tLABEL
                    {
#if 0
...
#endif
			{VALUE v1,v2,v3;v1=$1;v2=Qnil;v3=dispatch2(assoc_new,v1,v2);$$=v3;}
                    }
...
#endif
			{VALUE v1,v2,v3,v4,v5;v1=$2;v2=dispatch1(dyna_symbol,v1);v3=v2;v4=$4;v5=dispatch2(assoc_new,v3,v4);$$=v5;}
                    }
                | tDSTAR arg_value
                    {
#if 0
...
#endif
			{VALUE v1,v2;v1=$2;v2=dispatch1(assoc_splat,v1);$$=v2;}
                    }
                | tDSTAR
                    {
...
#endif
			{VALUE v1,v2;v1=Qnil;v2=dispatch1(assoc_splat,v1);$$=v2;}
                    }
                ;
